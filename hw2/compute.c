...
/* 
 * Get the processes to print in the proper order
 * Is there a more appropriate way to do this that more accurately demonstrates parallel programming?
 * Why doesn't the time go down when the count does?
 */