...
/* cmb TODO:
 * Instead of writing to file, write and return arrays of the exponentially distributed values to represent bursts in processes
 * Shift distribution slightly: don't start at 0